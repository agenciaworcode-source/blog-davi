...
import { getSocialLinks, type SocialLinks } from '@/lib/site-config'
...
interface SocialBarProps {
  /** 'sm' = ícones pequenos para nav | 'md' = ícones maiores para sidebar */
  size?: 'sm' | 'md'
  className?: string
}

export function SocialBar({ size = 'sm', className }: SocialBarProps) {
